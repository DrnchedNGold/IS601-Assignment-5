...
These tests verify that all arithmetic operations work correctly,
handle errors appropriately, and can be created through the factory.
"""
...
class BaseOperationTest:
    ...
    Subclasses define valid and invalid test cases, and this class
    runs them all automatically. Reduces code duplication.
    """
