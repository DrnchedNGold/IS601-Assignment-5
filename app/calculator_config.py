...
class CalculatorConfig:
    ...
    This class handles everything the calculator needs to know about how it should
    behave - where to save files, how many calculations to remember, how precise
    to be with decimals, etc. Settings can come from environment variables (like
    in a .env file) or be passed directly when creating the config.
    ...
    def __init__(
        ...
        This flexibility lets us configure the calculator for different environments
        (like development vs production) without changing code.
    ...
    def log_dir(self) -> Path:
        ...
        Using a property means this path is calculated when we need it, which
        allows environment variables to override it even after the config is created.
    ...
    def history_dir(self) -> Path:
        """
        Returns the directory where history files should be stored.

        By default, this creates a 'history' folder inside the base directory,
        but it can be overridden with an environment variable.
    ...
    def history_file(self) -> Path:
        """
        Returns the full path to the history CSV file.

        This is where we save all the calculations. It defaults to
        'calculator_history.csv' in the history directory.
    ...
    def log_file(self) -> Path:
        ...
        This is where we write diagnostic information and error messages.
        Defaults to 'calculator.log' in the log directory.
    ...
    def validate(self) -> None:
        ...
        This method verifies that the settings are valid before we try to use them.
        For example, history size and precision need to be positive numbers.
        Catching configuration errors early prevents confusing bugs later.
