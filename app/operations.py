...
class Operation(ABC):
    ...
    This is the Strategy pattern - each operation (add, subtract, etc.) is a
    different "strategy" for performing calculations. They all share the same
    interface (execute method), so the calculator can use any operation without
    knowing the specific details of how it works.
