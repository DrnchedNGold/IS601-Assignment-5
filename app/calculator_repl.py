...
def calculator_repl():
    ...
    REPL stands for Read-Eval-Print Loop - it's a pattern where the program:
    1. Reads input from the user
    2. Evaluates (processes) that input
    3. Prints the result
    4. Loops back to step 1

    This is how most command-line programs work. The user types commands,
    we figure out what they want, do it, show the result, and wait for the
    next command.
    """
    try:
        ...
        # The Observer pattern lets these components watch the calculator and
        # react to changes without the calculator needing to know about them
